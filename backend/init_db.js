    ...
    client
      ...
      .then(async () => {
        ...
        for (const place of content.items) {
          let name = place.fields.placeName.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let country = place.fields.country.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let images = place.fields.img.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let large_image = place.fields.largeImage.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let description = place.fields.description.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let lat = place.fields.geographicalInfo.lat
          let lon = place.fields.geographicalInfo.lon
          let author = place.fields.author.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let ranking = place.fields.ranking;
          let long_introduction = place.fields.longIntroduction.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let best_time = place.fields.bestTimeToGo.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let things_to_visit = place.fields.thingsToVisitRecommended.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let food_must_try = place.fields.foodMustTryRecommended.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
          let how_to_get_around = place.fields.howToGetAround.replaceAll(`“`,``).replaceAll(`"`,``).replaceAll(`”`,``).replaceAll(`'`,``);
